...
The external style sheet will only be included on pages that use syntax highlighting.

The default syntax highlighting style is called [friendly](https://xyproto.github.io/splash/docs/friendly.html).
To use a different style, generate a style sheet with the [hugo gen chromastyles](https://gohugo.io/commands/hugo_gen_chromastyles/) command and place it in the site directory under `assets/css/syntax.css`.
