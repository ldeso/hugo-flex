...
To prevent inline styles and automatically bundle an external style, switch the [markup.highlight.noClasses option](https://gohugo.io/functions/highlight/#options) and the params.noClasses option to false in the [site configuration](https://gohugo.io/getting-started/configuration/).

The default highlighting style is called [friendly](https://xyproto.github.io/splash/docs/friendly.html).
To change the highlighting style, generate a style sheet with the [hugo gen chromastyes](https://gohugo.io/commands/hugo_gen_chromastyles/) command and place it into the site directory at `assets/css/syntax.css`.
