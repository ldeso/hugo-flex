...
To avoid inline styles, this theme automatically bundles a style sheet for the default highlighting theme called [friendly](https://xyproto.github.io/splash/docs/friendly.html).
The style sheet is only bundled if syntax highlighting is used.
